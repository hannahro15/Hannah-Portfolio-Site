    ...
    return (
        <div className="about">
            ...
            <p>I am mainly a self-taught developer originally coming from a musical background. I have gone through various online courses and bootcamps to enhance my skills.
                My non-technical experience in music teaching, retail, customer service, libraries and administration.
            </p>
            <h2>Technical Skills</h2>
            <p>HTML, CSS, JavaScript, React, SQL, and Python. I also have experience with Git, GitHub, and Agile methodologies and databases like MongoDB.</p>
